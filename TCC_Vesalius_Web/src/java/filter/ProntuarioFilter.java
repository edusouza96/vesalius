 ...
 * @author Edu
 */
@WebFilter(filterName = "ProntuarioFilter", urlPatterns = {"/faces/prontuario/*"})
public class ProntuarioFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        int acesso = 0;
        try {
            System.out.println("Verificando acesso, procedimento!");
            ...
            System.out.println("Verificando acessoooooooo, procedimento!"+acesso);
    ...
    private int verificacao(String link, int acesso) throws Exception{
        ...
        switch(link){
            ...
            case "/prontuario/Prontuario.xhtml":
                return tipoAcesso.getRelatorioTipoAcessos();
            case "/prontuario/CadastroProntuario.xhtml":
                return tipoAcesso.getRelatorioTipoAcessos();
            default:
                return 0;
        }
