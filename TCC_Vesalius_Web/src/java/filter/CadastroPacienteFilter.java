 ...
 * @author Edu
 */
@WebFilter(filterName = "CadastroPacienteFilter", urlPatterns = {"/faces/CadastroPaciente.xhtml"})
public class CadastroPacienteFilter implements Filter {
    ...
    private int verificacao(String link, int acesso) throws Exception{
        ...
        switch(link){
            ...
            case "/ListaPacientes.xhtml":
                return tipoAcesso.getEstoqueTipoAcessos();//mudar
            case "/CadastroPaciente.xhtml":
                return tipoAcesso.getEstoqueTipoAcessos();
            default:
                return 0;
        }
    }
